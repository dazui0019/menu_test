...
static void enterAction( void *stateData, struct event *event );
...
static struct state lcdGroupState = {
    ...
    .numTransitions = 2,
    .data = &(struct stateData){.num=UI_GROUP, .str="lcd"},
    .entryAction = enterAction,
...
static struct state idleState = {
    ...
    .numTransitions = 3,
    .data = &(struct stateData){.num=UI_IDLE, .str="idle"},
    .entryAction = enterAction,
    .exitAction = exitAction,
};
...
static struct state menuGroupState = {
    ...
    .numTransitions = 2,
    .data = &(struct stateData){.num=UI_MENU, .str="menu"},
    .entryAction = enterAction,
    .exitAction = exitAction,
};
...
static struct state selCurState = {
    ...
    .numTransitions = 4,
    .data = &(struct stateData){.num=UI_CUR_SEL, .str="cur selcted"},
    .entryAction = enterAction,
    .exitAction = exitAction,
};
...
static struct state selDlyState = {
    ...
    .numTransitions = 4,
    .data = &(struct stateData){.num=UI_DLY_SEL, .str="dly selcted"},
    .entryAction = enterAction,
    .exitAction = exitAction,
};
...
static struct state setCurState = {
    ...
    .numTransitions = 4,
    .data = &(struct stateData){.num=UI_CUR_SET, .str="cur setting"},
    .entryAction = enterAction,
    .exitAction = exitAction,
};
...
static struct state setDlyState = {
    ...
    .numTransitions = 4,
    .data = &(struct stateData){.num=UI_DLY_SET, .str="dly setting"},
    .entryAction = enterAction,
    .exitAction = exitAction,
};
...
void setup()
{
    ...
    stateM_init( &m, &lcdGroupState, &errorState );
...
static void enterAction(void *stateData, struct event *event)
{
    ...
    ui_print_state((UI_StateTypeDef)data->num);
    ui_disp_page((UI_StateTypeDef)data->num);
}
